            ...
            <nav class="sidebar-nav">
                @auth
                    ...
                    @elseif(auth()->user()->role === 'admin')
                        ...
                        <a href="{{ route('admin.activity-logs') }}" class="nav-link {{ request()->is('admin/activity-logs*') ? 'active' : '' }}">
                            <span class="nav-icon">
                                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M9 17v-2m3 2v-4m3 4V7m-9 12h12a2 2 0 002-2V7a2 2 0 00-2-2H6a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                                </svg>
                            </span>
