  ...
  <section class="about" id="about">
    <div class="about-inner">
      ...
      <div class="city-banner" id="city-banner">
        <div class="about-icon" style="font-size: 4rem; margin-bottom: 16px; text-align:center;">ðŸ›ï¸</div>
        ...
        <div class="service-card">
          ...
          <a href="#announcements" class="service-link">View News â€º</a>
        </div>
        ...
        <div class="service-card">
          ...
          <a href="{{ route('login') }}" class="service-link">Enable Alerts â€º</a>
        </div>
      </div>
    </div>
  </section>
      ...
      <p style="text-align: center; max-width: 800px; margin: 0 auto 60px; font-size: 1.05rem; color: var(--text-light); line-height: 1.8;">
        ...
        and communicate with officials seamlesslyâ€”anytime, anywhere.
      </p>
    ...
    <div class="footer-inner">
      <div class="footer-brand">
        ...
        <p style="margin-top: 20px; font-size: 0.85rem;">
          Â© 2026 PROJECT CONNECT. All rights reserved.
        </p>
      </div>
